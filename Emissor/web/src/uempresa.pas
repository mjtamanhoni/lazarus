...
type
  ...
  TfrmEmpresa = class(TfrmPrincipal)
    ...
    DBGrid: TDBGrid;
    edPesquisar: TEdit;
    mdCertificadoDigitalcaminhoArquivo: TStringField;
    mdCertificadoDigitalidCertificado: TLongintField;
    mdCertificadoDigitalidEmpresa: TLongintField;
    mdCertificadoDigitalsenha: TStringField;
    mdCertificadoDigitaltipo: TStringField;
    mdCertificadoDigitaltipoDesc: TStringField;
    mdCertificadoDigitalvalidade: TDateField;
    mdEnderecobairro: TStringField;
    mdEnderecocep: TStringField;
    mdEnderecocodigoMunicipioIbge: TStringField;
    mdEnderecocodigoPaisIbge: TStringField;
    mdEnderecocomplemento: TStringField;
    mdEnderecoidEmpresa: TLongintField;
    mdEnderecoidEndereco: TLongintField;
    mdEnderecologradouro: TStringField;
    mdEnderecomunicipio: TStringField;
    mdEndereconumero: TStringField;
    mdEnderecopais: TStringField;
    mdEnderecotipoEndereco: TLongintField;
