...
uses
  ...
  Menus, ExtCtrls, StdCtrls, D2Bridge.Forms; //Declare D2Bridge.Forms always in the last unit
...
type
  ...
  TForm_Login = class(TD2BridgeForm)
   ...
   lbCadUsuario: TLabel;
    ...
    procedure lbCadEmpresaClick(Sender: TObject);
    procedure lbCadUsuarioClick(Sender: TObject);
  private
...
procedure TForm_Login.lbCadEmpresaClick(Sender: TObject);
begin
  ShowMessage('Cadastra Empresa');
end;

procedure TForm_Login.lbCadUsuarioClick(Sender: TObject);
begin
  ShowMessage('Cadastra Usuário');
end;
 ...
 begin
  ...
  begin
   ...
   begin
    ...
    with Row.Items.Add do
      Col.Add.VCLObj(lbCadEmpresa);

    with Row.Items.Add do
      Col.Add.VCLObj(lbCadUsuario);
